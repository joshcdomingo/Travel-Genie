...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http,
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET, "/api/travelgenie", "/api/travelgenie/*", "/api/travelgenie/wish", "/api/travelgenie/wish/*", "/api/travelgenie/wish/user","/api/travelgenie/wish/user/*", "/api/travelgenie/wish/match").hasAnyAuthority("USER")
